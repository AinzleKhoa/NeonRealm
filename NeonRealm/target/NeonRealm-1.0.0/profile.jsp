...
<c:if test="${empty user}">
    <% response.sendRedirect(getServletContext().getContextPath() + "/404.jsp"); %>
</c:if>
<!-- page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="section__wrap">
                    ...
                    <!-- breadcrumb -->
                    <ul class="breadcrumb">
                        <li class="breadcrumb__item"><a href="<%= getServletContext().getContextPath()%>/index.jsp">Home</a></li>
                ...
                <div class="profile">
                    <div class="profile__user">
                        <div class="profile__avatar">
                            <img src="<%= getServletContext().getContextPath()%>/assets/img/user.svg" alt="">
                        </div>
