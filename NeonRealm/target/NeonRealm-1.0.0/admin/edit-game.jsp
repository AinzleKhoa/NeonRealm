        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <div class="card">
                        <div class="card-header"><h3 class="card-title">Chỉnh Sửa Game</h3></div>
                        <div class="card-body">
                            ...
                            <form action="${pageContext.request.contextPath}/admin/games" method="post" enctype="multipart/form-data">
                                ...
                                <%-- Dropdowns cho các danh mục --%>
                                <c:forEach items="${[ 
                                                    ['genres', 'Thể Loại', allGenres, game.genres], 
                                                    ['categories', 'Danh Mục', allCategories, game.categories], 
                                                    ['developers', 'Nhà Phát Triển', allDevelopers, game.developers], 
                                                    ['publishers', 'Nhà Phát Hành', allPublishers, game.publishers], 
                                                    ['platforms', 'Nền Tảng', allPlatforms, game.platforms] 
                                                    ]}" var="attr">
                                           <div class="mb-3">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/games" class="btn btn-secondary">Hủy</a>
                            </form>
                        </div>
                    </div>
                </div>
