<%-- 
    Document   : footer
    Created on : Feb 15, 2025, 9:50:00 AM
    Author     : Ainzle
--%>
        ...
        <div class="row">
            <div class="col-12">
                <div class="footer__navs">
                    <div class="footer__nav footer__nav--1">
                        <div class="footer__title"><svg xmlns='http://www.w3.org/2000/svg' width='512' height='512' viewBox='0 0 512 512'><polygon points='336 320 32 320 184 48 336 320' style='fill:none;stroke-linejoin:round;stroke-width:32px'/><path d='M265.32,194.51A144,144,0,1,1,192,320' style='fill:none;stroke-linejoin:round;stroke-width:32px'/></svg> <span>NeonRealm</span></div>

                        <nav class="footer__list">
                            <a href="<%= getServletContext().getContextPath() %>/pages/about.jsp">About Us</a>
                            <a href="<%= getServletContext().getContextPath() %>/pages/catalog.html">Catalog</a>
                            <a href="<%= getServletContext().getContextPath() %>/pages/faq.html">Help Center</a>
                        </nav>
                    </div>
                    ...
                    <div class="footer__nav footer__nav--3">
                        ...
                        <div class="footer__contacts">
                            ...
                            <a class="footer__link" href="mailto:neonrealm@gmail.com">support@neonrealm</a>
            ...
            <div class="col-12">
                <div class="footer__wrap">
                    <a class="footer__logo" href="<%= getServletContext().getContextPath() %>/index.html">
                        <img src="<%= getServletContext().getContextPath()%>/assets/img/logo.png" alt="">
                    </a>

                    <span class="footer__copyright">© NeonRealm, 2025 <br> Create by <a href="https://themeforest.net/user/dmitryvolkov/portfolio" target="_blank">NeonRealm Team</a></span>
                </div>
            </div>
        </div>
    </div>
