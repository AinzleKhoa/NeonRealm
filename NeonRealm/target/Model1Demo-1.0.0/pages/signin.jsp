                ...
                <div class="col-12">
                    <div class="sign__content">
                        ...
                        <form action="#" class="sign__form">
                            ...
                            <span class="sign__text">Don't have an account? <a href="<%= getServletContext().getContextPath()%>/pages/signup.jsp">Sign up!</a></span>

                            <span class="sign__text"><a href="<%= getServletContext().getContextPath()%>/pages/forgot.jsp">Forgot password?</a></span>
                        </form>
