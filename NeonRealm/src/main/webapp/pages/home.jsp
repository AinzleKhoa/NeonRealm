...
<section class="section section--bg section--first" data-bg="<%= getServletContext().getContextPath()%>/img/bg.jpg">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <div class="section__title-wrap">
                    <h2 class="section__title section__title--title"><b>Controller Friendly</b></h2>
    ...
    <div class="owl-carousel section__carousel section__carousel--big" id="carousel0">
        <%
            if (gamesByCategory != null && !gamesByCategory.isEmpty()) {
                for (Game g : gamesByCategory) {
                    if (g.getCategories().contains("Controller Friendly")) {
        %>
        <!-- big card -->
        <div class="card card--big">
            <a href="<%= getServletContext().getContextPath()%>/pages/details.jsp" class="card__cover">
...
<section class="section section--bg section--first" data-bg="<%= getServletContext().getContextPath()%>/img/bg.jpg">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <div class="section__title-wrap">
                    <h2 class="section__title section__title--title"><b>Single-Player Focused</b></h2>
    ...
    <div class="owl-carousel section__carousel section__carousel--big" id="carousel0">
        <%
            if (gamesByCategory != null && !gamesByCategory.isEmpty()) {
                for (Game g : gamesByCategory) {
                    if (g.getCategories().contains("Single-Player Focused")) {
        %>
        <!-- big card -->
        <div class="card card--big">
            <a href="<%= getServletContext().getContextPath()%>/pages/details.jsp" class="card__cover">
...
<section class="section section--bg section--first" data-bg="<%= getServletContext().getContextPath()%>/img/bg.jpg">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <div class="section__title-wrap">
                    <h2 class="section__title section__title--title"><b>Special Discounts</b> of this month</h2>
    ...
    <div class="owl-carousel section__carousel section__carousel--big" id="carousel0">
        <%
            if (gamesByCategory != null && !gamesByCategory.isEmpty()) {
                for (Game g : gamesByCategory) {
                    if (g.getCategories().contains("Special Discounts")) {
        %>
        <!-- big card -->
        <div class="card card--big">
            <a href="<%= getServletContext().getContextPath()%>/pages/details.jsp" class="card__cover">
...
<section class="section section--bg section--first" data-bg="<%= getServletContext().getContextPath()%>/img/bg.jpg">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <div class="section__title-wrap">
                    <h2 class="section__title section__title--title"><b>VR Compatible</b></h2>
    ...
    <div class="owl-carousel section__carousel section__carousel--big" id="carousel0">
        <%
            if (gamesByCategory != null && !gamesByCategory.isEmpty()) {
                for (Game g : gamesByCategory) {
                    if (g.getCategories().contains("VR Compatible")) {
        %>
        <!-- big card -->
        <div class="card card--big">
            <a href="<%= getServletContext().getContextPath()%>/pages/details.jsp" class="card__cover">
        ...
        <div class="row catalog-page">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card card--catalog">
                    <a href="<%= getServletContext().getContextPath()%>/gamedetails?game_id=<%= g.getGameId()%>" class="card__cover">
                    ...
                    <div class="card__title">
                        <h3><a href="<%= getServletContext().getContextPath()%>/pages/details.jsp?id=<%= g.getGameId()%>"><%= g.getTitle()%></a></h3>
                        <span><%= g.getPrice()%></span>
                    </div>
                </div>
            </div>
