...
<body>
    ...
    <header class="header">
        <style>
            ...
            #cart-total-price {
                margin-right: 5px; /* Tạo khoảng cách giữa totalPrice và cartCount */
                font-weight: bold;
            }
                    ...
                    <div class="col-12">
                        <div class="header__content">
                            ...
                            <div class="header__actions">
                                ...
                                %>
                                <a href="CheckoutServlet" action="viewCart" class="header__cart-link">
                                    <svg xmlns='http://www.w3.org/2000/svg' width='512' height='512' viewBox='0 0 512 512'>
                                    ...
                                    <span id="cart-total-price">$<%= String.format("%.2f", totalPrice)%></span>
