    ...
    <div class="container">
        ...
        <div class="row catalog">
                    ...
                    <div class="col-12">
                        <div class="filter-wrap">
                            ...
                            <div class="collapse filter-wrap__content" id="collapseFilter">
                                <!-- filter -->
                                <form class="filter" method="POST" action="${pageContext.servletContext.contextPath}/catalog">
            ...
            <div class="col-12 col-lg-80">
                <c:choose>
                    <c:when test="${empty requestScope.filteredGameList}">

                        <c:choose>
                            <c:when test="${not empty requestScope.gameListPerPage}">
                                <!-- paginator -->
                                <div class="col-12">
                                    <div class="paginator">
                                        <neon:pagination currentPage="${param.page}" totalPages="${requestScope.numOfPages}" url="${pageContext.servletContext.contextPath}/catalog"></neon:pagination>
                                ...
                                <!-- end paginator -->
                                <div class="row">
                                    <c:forEach var="g" items="${requestScope.gameListPerPage}">
                                        <!-- card -->
                    ...
                    <c:otherwise>
                        ...
                        <div class="row">
                            <c:forEach var="g" items="${requestScope.filteredGameList}">
                                <!-- card -->
                                <div class="col-12 col-sm-6 col-md-4 col-xl-3">
                                    <div class="card card--catalog">
                                        <a href="${pageContext.servletContext.contextPath}/gamedetails?id=${g.gameId}" class="card__cover">
