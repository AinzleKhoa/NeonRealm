                        ...
                        <form action="${pageContext.servletContext.contextPath}/signup" method="POST" class="sign__form">
                            ...
                            <div class="sign__group sign__group--checkbox">
                                <input id="remember" name="remember" type="checkbox" checked="checked">
                                    <label for="remember">I agree to the <a href="${pageContext.servletContext.contextPath}/pages/privacy.jsp">Privacy Policy</a></label>
                            </div>
                            --%>
