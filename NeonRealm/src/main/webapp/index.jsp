    ...
    <div class="owl-carousel section__carousel section__carousel--big" id="carousel0">
        ...
        <div class="card card--big">
            <a href="<%= getServletContext().getContextPath()%>/pages/details.jsp" class="card__cover">
                <img src="<%= getServletContext().getContextPath()%>/assets/img/cards/4.jpg" alt="">
            </a>

            <div class="card__wrap">
                <div class="card__title">
                    <h3><a href="<%= getServletContext().getContextPath()%>/pages/details.jsp">X4: Foundations Collector's Edition</a></h3>
                </div>
        ...
        <div class="card card--big">
            <a href="<%= getServletContext().getContextPath()%>/pages/details.jsp" class="card__cover">
                <img src="<%= getServletContext().getContextPath()%>/assets/img/cards/2.jpg" alt="">
            </a>

            <div class="card__wrap">
                <div class="card__title">
                    <h3><a href="<%= getServletContext().getContextPath()%>/pages/details.jsp">The Witcher 3: Wild Hunt</a></h3>
                </div>
        ...
        <div class="card card--big">
            <a href="<%= getServletContext().getContextPath()%>/pages/details.jsp" class="card__cover">
                <img src="<%= getServletContext().getContextPath()%>/assets/img/cards/9.jpg" alt="">
            </a>

            <div class="card__wrap">
                <div class="card__title">
                    <h3><a href="<%= getServletContext().getContextPath()%>/pages/details.jsp">The Legend of Heroes: Trails in the Sky SC</a></h3>
                </div>
        ...
        <div class="card card--big">
            <a href="<%= getServletContext().getContextPath()%>/pages/details.jsp" class="card__cover">
                <img src="<%= getServletContext().getContextPath()%>/assets/img/cards/5.jpg" alt="">
            </a>

            <div class="card__wrap">
                <div class="card__title">
                    <h3><a href="<%= getServletContext().getContextPath()%>/pages/details.jsp">Pillars of Eternity: Hero Edition</a></h3>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="section__title-wrap section__title-wrap--single">
                    ...
                    <div class="section__nav-wrap">
                        <a href="<%= getServletContext().getContextPath()%>/pages/catalog.jsp" class="section__view">View All</a>
                    </div>
                </div>
            </div>
            <!-- end title -->
        ...
        <div class="row catalog-page">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card card--catalog">
                    ...
                    <div class="card__title">
                        <h3><a href="<%= getServletContext().getContextPath()%>/pages/details.jsp">Desperados III Digital Deluxe Edition</a></h3>
                        <span>$49.00</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card card--catalog">
                    <a href="<%= getServletContext().getContextPath()%>/pages/details.jsp" class="card__cover">
                        <img src="<%= getServletContext().getContextPath()%>/assets/img/cards/7.jpg" alt="">
                        <span class="card__new">New</span>
                    </a>
                    ...
                    <div class="card__title">
                        <h3><a href="<%= getServletContext().getContextPath()%>/pages/details.jsp">Red Dead Redemption 2</a></h3>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card card--catalog">
                    <a href="<%= getServletContext().getContextPath()%>/pages/details.jsp" class="card__cover">
                        <img src="<%= getServletContext().getContextPath()%>/assets/img/cards/1.jpg" alt="">
                    ...
                    <div class="card__title">
                        <h3><a href="<%= getServletContext().getContextPath()%>/pages/details.jsp">Dandara: Trials of Fear Edition</a></h3>
                        <span>$18.00</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card card--catalog">
                    <a href="<%= getServletContext().getContextPath()%>/pages/details.jsp" class="card__cover">
                        <img src="<%= getServletContext().getContextPath()%>/assets/img/cards/8.jpg" alt="">
                    </a>
                    ...
                    <div class="card__title">
                        <h3><a href="<%= getServletContext().getContextPath()%>/pages/details.jsp">Druidstone: The Secret of the Menhir Forest</a></h3>
                        <span>$12.49</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card card--catalog">
                    <a href="<%= getServletContext().getContextPath()%>/pages/details.jsp" class="card__cover">
                        <img src="<%= getServletContext().getContextPath()%>/assets/img/cards/3.jpg" alt="">
                    </a>
                    ...
                    <div class="card__title">
                        <h3><a href="<%= getServletContext().getContextPath()%>/pages/details.jsp">Baldur's Gate II: Enhanced Edition</a></h3>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card card--catalog">
                    <a href="<%= getServletContext().getContextPath()%>/pages/details.jsp" class="card__cover">
                        <img src="<%= getServletContext().getContextPath()%>/assets/img/cards/6.jpg" alt="">
                    </a>
                    ...
                    <div class="card__title">
                        <h3><a href="<%= getServletContext().getContextPath()%>/pages/details.jsp">Baldur's Gate: Enhanced Edition</a></h3>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card card--catalog">
                    ...
                    <div class="card__title">
                        <h3><a href="<%= getServletContext().getContextPath()%>/pages/details.jsp">SteamWorld Quest: Hand of Gilgamech</a></h3>
                        <span>$12.49</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card card--catalog">
                    ...
                    <div class="card__title">
                        <h3><a href="<%= getServletContext().getContextPath()%>/pages/details.jsp">Outcast - Second Contact</a></h3>
                        <span>$34.99</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <div class="card card--catalog">
                    ...
                    <div class="card__title">
                        <h3><a href="<%= getServletContext().getContextPath()%>/pages/details.jsp">BioShock Infinite Complete Edition</a></h3>
