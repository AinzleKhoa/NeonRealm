    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (isUploadAvatar.equals("upload")) {
            ...
            if (filePart != null && filePart.getSize() > 0) {
                ...
                // Optionally, you can store the file path in the database for the user's profile
                UserDAO uDAO = new UserDAO();
                uDAO.updateProfileImage(user.getUserId(), "/uploads/" + fileName);

                // Redirect or forward to the profile page with success message
                request.setAttribute("success", "Profile image uploaded successfully!");
            }
        } else {
