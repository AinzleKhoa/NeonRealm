...
DECLARE @order_id_user1 INT, @order_id_user2 INT;

-- Insert Order for User 1 (with SUMMER20 discount)
INSERT INTO Orders (user_id, total_price, discount_code)
VALUES (1, 95.98, 'SUMMER20');
SET @order_id_user1 = SCOPE_IDENTITY();

-- Insert Order Details for User 1
...
-- Insert Order for User 2 (with WELCOME10 discount)
INSERT INTO Orders (user_id, total_price, discount_code)
VALUES (2, 59.99, 'WELCOME10');
SET @order_id_user2 = SCOPE_IDENTITY();

-- Insert Order Details for User 2
INSERT INTO Order_Details (order_id, game_id, price)
VALUES 
(@order_id_user2, 2, 59.99);   -- The Witcher 3
