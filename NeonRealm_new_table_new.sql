...
-- Insert Users
INSERT INTO Users (username, email, password_hash, full_name, phone, google_auth_id) VALUES
('user1', 'user1@example.com', 'hash1', 'John Doe', '1234567890', NULL),
('user2', 'user2@example.com', 'hash2', 'Jane Smith', '0987654321', NULL),
('user3', 'user3@example.com', 'hash3', 'Alice Brown', '1112223333', 'google_123');
GO
...
(14, 1), -- Halo Infinite → PC
(14, 3), -- Halo Infinite → Xbox
(15, 1), -- Forza Horizon 5 → PC
(15, 3), -- Forza Horizon 5 → Xbox
(16, 1), -- Street Fighter 6 → PC
(16, 2), -- Street Fighter 6 → PlayStation
(16, 3), -- Street Fighter 6 → Xbox
(17, 2), -- The Last of Us Part II → PlayStation
(18, 1), -- Monster Hunter World → PC
(18, 2), -- Monster Hunter World → PlayStation
(18, 3), -- Monster Hunter World → Xbox
(19, 1), -- Starfield → PC
(19, 3), -- Starfield → Xbox
(20, 1), -- Baldur’s Gate 3 → PC
(20, 2), -- Baldur’s Gate 3 → PlayStation
(20, 3), -- Baldur’s Gate 3 → Xbox
(20, 7), -- Baldur’s Gate 3 → Mac
(20, 8), -- Baldur’s Gate 3 → Linux
(21, 1), (21, 2), (21, 3),  -- Dead by Daylight → PC, PlayStation, Xbox
(22, 1), (22, 2), (22, 4),  -- Five Nights at Freddy’s: Security Breach → PC, PlayStation, Nintendo Switch
(23, 1), (23, 6),           -- Phasmophobia → PC, VR
(24, 1), (24, 2), (24, 3),  -- The Forest → PC, PlayStation, Xbox
(25, 1), (25, 2),           -- Amnesia: The Bunker → PC, PlayStation
(26, 1), (26, 2), (26, 3),  -- The Sims 4 → PC, PlayStation, Xbox
(27, 1),                    -- Cities: Skylines II → PC
(28, 1), (28, 2), (28, 3),  -- Farming Simulator 22 → PC, PlayStation, Xbox
(29, 1),                    -- Euro Truck Simulator 2 → PC
(30, 1), (30, 2),           -- PowerWash Simulator → PC, PlayStation
(31, 1), (31, 2),           -- Civilization VI → PC, PlayStation
(32, 1),                    -- Total War: Warhammer III → PC
(33, 1), (33, 3),           -- Age of Empires IV → PC, Xbox
(34, 1), (34, 2),           -- XCOM 2 → PC, PlayStation
(35, 1),                    -- Crusader Kings III → PC
(36, 1), (36, 2), (36, 3),  -- FIFA 24 → PC, PlayStation, Xbox
(37, 1), (37, 2), (37, 3),  -- NBA 2K24 → PC, PlayStation, Xbox
(38, 1), (38, 2), (38, 3),  -- Madden NFL 24 → PC, PlayStation, Xbox
(39, 1), (39, 2),           -- Tony Hawk’s Pro Skater 1+2 → PC, PlayStation
(40, 1), (40, 2), (40, 3),  -- WWE 2K24 → PC, PlayStation, Xbox
(41, 1), (41, 2), (41, 3),  -- Mortal Kombat 11 → PC, PlayStation, Xbox
(42, 1), (42, 2), (42, 3),  -- Tekken 8 → PC, PlayStation, Xbox
(43, 1), (43, 2),           -- Guilty Gear Strive → PC, PlayStation
(44, 1), (44, 2), (44, 3),  -- Dragon Ball FighterZ → PC, PlayStation, Xbox
(45, 4),                    -- Super Smash Bros. Ultimate → Nintendo Switch
(46, 1), (46, 2),           -- Gran Turismo 7 → PC, PlayStation
(47, 1), (47, 2), (47, 3),  -- Need for Speed: Unbound → PC, PlayStation, Xbox
(48, 1), (48, 2), (48, 3),  -- F1 23 → PC, PlayStation, Xbox
(49, 1), (49, 2),           -- MotoGP 23 → PC, PlayStation
(50, 1), (50, 2),           -- Wreckfest → PC, PlayStation
(51, 1), (51, 6),        -- Beat Saber → PC, VR
(52, 1), (52, 2), (52, 4), -- Just Dance 2024 → PC, PlayStation, Nintendo Switch
(53, 1), (53, 5),        -- Friday Night Funkin’ → PC, Mobile
(54, 4),                 -- Mario Party Superstars → Nintendo Switch
(55, 1), (55, 2), (55, 3), -- Gang Beasts → PC, PlayStation, Xbox
(56, 1), (56, 4), (56, 5), -- Jackbox Party Pack 9 → PC, Nintendo Switch, Mobile
(57, 1), (57, 2), (57, 3), (57, 5), -- Genshin Impact → PC, PlayStation, Xbox, Mobile
(58, 5),                 -- Clash Royale → Mobile
(59, 1), (59, 2), (59, 3), (59, 4), (59, 5), -- Among Us → PC, PlayStation, Xbox, Nintendo Switch, Mobile
(60, 1), (60, 4), (60, 5), -- Stardew Valley → PC, Nintendo Switch, Mobile
(61, 1), (61, 5),        -- Hearthstone → PC, Mobile
(62, 1), (62, 8),        -- Celeste → PC, Linux
(63, 1), (63, 8),        -- Terraria → PC, Linux
(64, 1), (64, 7),        -- The Binding of Isaac: Rebirth → PC, Mac
(65, 1), (65, 7),        -- Hollow Knight → PC, Mac
(66, 1), (66, 6),        -- Half-Life: Alyx → PC, VR
(67, 1), (67, 6),        -- The Walking Dead: Saints & Sinners → PC, VR
(68, 1), (68, 6);        -- Boneworks → PC, VR
GO
...
INSERT INTO Orders (user_id, total_price, discount_code) VALUES
(1, 59.99, 'WELCOME10'), -- User 1 used a discount
(2, 39.99, NULL),       -- User 2 bought without a discount
(3, 79.99, 'SUMMER20'); -- User 3 applied a 20% discount
GO

INSERT INTO Order_Details (order_id, game_id, price) VALUES
(1, 5, 59.99), -- Elden Ring in Order 1
(2, 12, 39.99), -- Horizon Forbidden West in Order 2
(3, 20, 79.99); -- Baldur’s Gate 3 in Order 3
GO

INSERT INTO Cart (user_id, game_id) VALUES
(1, 3),  -- User 1 added GTA V to their cart
(2, 8),  -- User 2 added DOOM Eternal to their cart
(3, 17); -- User 3 added The Last of Us Part II to their cart
GO
